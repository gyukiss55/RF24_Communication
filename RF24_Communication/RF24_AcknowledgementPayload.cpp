//RF24_AcknowledgementPayload.cpp

#include "Arduino.h"
#include <SPI.h>
#include "RF24_Definitions.h"

#if defined (_RF24_ACKNOWLEDGEMENTPAYLOAD_TEST_)
/*
...
#include "RF24_AcknowledgementPayload.h"
...
void SetupAcknowledgementPayload()
{
    SetupRF24();
    radio.begin();
...
void LoopAcknowledgementPayload() {
